<?php
  ...
  if(isset($_REQUEST['empupdate'])){
    if(($_REQUEST['empName'] == "") || ($_REQUEST['empCity'] == "") || ($_REQUEST['empMobile'] == "") || ($_REQUEST['empEmail'] == "")){
      ...
      $sql = "UPDATE technicians_tb SET empName = '$eName', empCity = '$eCity', empMobile = '$eMobile', empEmail = '$eEmail' WHERE empid = '$eId'";
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
  ...
  <?php
    if(isset($_REQUEST['edit'])){
      $sql = "SELECT * FROM technicians_tb WHERE empid = {$_REQUEST['id']}";
