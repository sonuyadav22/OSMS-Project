<?php
    ...
    if(isset($_REQUEST['psubmit'])){
        if(($_REQUEST['cname'] == "") || ($_REQUEST['cadd'] == "") || ($_REQUEST['pname'] == "") || ($_REQUEST['pquantity'] == "") || ($_REQUEST['psellingcost'] == "") || ($_REQUEST['totalcost'] == "") || ($_REQUEST['selldate'] == "")){
            ...
            $sql = "UPDATE assets_tb SET pavail = '$pavail' WHERE pid = '$pid'";
            $conn->query($sql);
        }
    }
?>
...
<div class="col-sm-6 mt-5 mx-3 jumbotron">
    ...
    <form action="" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="pavail" name="pavail" onkeypress="isInputNumber(event)" value="<?php if(isset($row['pavail'])) {echo $row['pavail']; }?>" readonly>
        </div>
        <div class="form-group">
