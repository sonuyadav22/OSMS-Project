    ...
    <div class="container">
      ...
      <div class="row mt-5">
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="image/avtar1.jpeg" class="img-fluid" style="border-radius: 100px;">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="image/avtar2.jpeg" class="img-fluid" style="border-radius: 100px;">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="image/avtar4.jpeg" class="img-fluid" style="border-radius: 100px;">
    ...
    <div class="container">
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Sonu Yadav &copy; 2025.
          </small>
